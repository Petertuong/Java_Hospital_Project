...
import service.MultiService.BedRoomSyncManager;
...
public class BedController {
    ...
    private final BedRoomSyncManager syncManager = new BedRoomSyncManager();
    ...
    private void handleAddBed() {
        ...
        try {
            ...
            syncManager.updateRoomBedAvailability(roomNo);
    ...
    private void handleUpdateBed() {
        ...
        try {
            ...
            syncManager.updateRoomBedAvailability(oldRoomNo);
            if (oldRoomNo != roomNo) {
                syncManager.updateRoomBedAvailability(roomNo);
            }
        ...
        alert.showAndWait().ifPresent(result -> {
            if (result == ButtonType.OK) {
                try {
                    ...
                    if (deletedRoomNo > 0) {
                        syncManager.updateRoomBedAvailability(deletedRoomNo);
                    }
